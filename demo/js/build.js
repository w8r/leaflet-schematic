...
module.exports = SvgLayer.extend({
  ...
  onAdd: function onAdd(map) {
    ...
    map.on('zoomend', this._onMapZoomEnd, this).on('dragstart', this._onPreDrag, this).on('dragend', this._onDragEnd, this);
  ...
  onRemove: function onRemove(map) {
    ...
    map.off('zoomend', this._onMapZoomEnd, this).off('dragstart', this._onPreDrag, this).off('dragend', this._onDragEnd, this);
    return this;
  },
  ...
  _redrawCanvas: function _redrawCanvas(topLeft) {
    if (this._canvas) {
      var vp = this._getViewport();
      var min = vp.min;
      var max = vp.max;
