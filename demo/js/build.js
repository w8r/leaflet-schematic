...
var SVGOverlay = SvgLayer.extend({
  ...
  _reset: function _reset() {
    ...
    this._group.setAttribute('transform', L.DomUtil.getMatrixString(topLeft.subtract(L.point(this._bbox[0], this._bbox[1]).multiplyBy(scale)), scale));
  }
