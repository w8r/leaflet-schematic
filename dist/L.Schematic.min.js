 ...
 * @extends {L.Rectangle}
 */
r.Schematic=e.exports=r.Rectangle.extend({options:{opacity:0,fillOpacity:0,weight:1,adjustToScreen:true,zoomOffset:0,interactive:false,useRaster:r.Browser.ie||r.Browser.gecko||r.Browser.edge},initialize:function s(t,e,i){this._svg=t;this._initialWidth="";this._initialHeight="";if(!(e instanceof r.LatLngBounds)){i=e;e=null}i.renderer=new o({schematic:this});this._bounds=e;this._ratio=1;this._size=null;this._origin=null;this._transformation=null;this._base64encoded="";this._rawData="";this._viewBoxOffset=r.point(0,0);this._ready=false;if(typeof t==="string"&&!/\<svg/gi.test(t)){this._svg=null;this._url=t;if(!i.load){throw new Error("SVGOverlay requires external request implementation. "+"You have to provide `load` function with the options")}}this._group=null;this._canvasRenderer=null;this._raster=null;this._rasterShown=false;r.Rectangle.prototype.initialize.call(this,r.latLngBounds([0,0],[0,0]),i)},onAdd:function a(t){r.Rectangle.prototype.onAdd.call(this,t);this._ready=false;if(!this._group){this._group=r.SVG.create("g");r.Util.stamp(this._group);r.DomUtil.addClass(this._group,"svg-overlay")}if(!this._svg){this.load()}else{this.onLoad(this._svg)}if(r.Browser.gecko){this._path.setAttribute("pointer-events","none")}if(this.options.useRaster){var e=new r.Canvas({}).addTo(t);e._container.parentNode.insertBefore(e._container,this._renderer._container);this._canvasRenderer=e;t.dragging._draggable.on("predrag",this._onPreDrag,this).on("dragend",this._onDragEnd,this);e._container.style.visibility="hidden"}},onRemove:function h(t){this._group.parentNode.removeChild(this._group);r.Rectangle.prototype.onRemove.call(this,t);if(this._canvasRenderer){this._canvasRenderer.removeFrom(t);t.dragging._draggable.off("predrag",this._onPreDrag,this).off("dragend",this._onDragEnd,this)}this._renderer.removeFrom(t)},load:function u(){this.options.load(this._url,r.Util.bind(function(t,e){if(t){this.onError(t)}else{this.onLoad(e)}},this))},_readSVGData:function l(t){var e=new DOMParser;var i=new XMLSerializer;var n=e.parseFromString(t,"application/xml");var o=n.documentElement;if(o.querySelector("parsererror")!==null){return this.onError(new Error("SVG parse error"))}this._initialWidth=o.getAttribute("width");this._initialHeight=o.getAttribute("height");this._bbox=r.DomUtil.getSVGBBox(o);var s=this._bbox[2]-this._bbox[0];var a=this._bbox[3]-this._bbox[1];if(parseFloat(this._initialWidth)!==s||parseFloat(this._initialHeight)!==a){o.setAttribute("width",s);o.setAttribute("height",a)}this._rawData=t;this._processedData=i.serializeToString(n);if(o.getAttribute("viewBox")===null){o.setAttribute("viewBox",this._bbox.join(" "));this._processedData=this._processedData.replace("<svg",'<svg viewBox="'+this._bbox.join(" ")+'"')}return o},onError:function c(t){if(this.options.onError){this.options.onError.call(this,{error:t})}return this.fire("error",{error:t})},onLoad:function d(t){if(!this._map){return}t=this._readSVGData(t);var e=this._bbox;var i=this.getOriginalSize();var n=this._map.getSize();if(this.options.adjustToScreen&&i.y!==n.y){this._ratio=Math.min(n.x/i.x,n.y/i.y);this.options._zoomOffset=this._ratio<1?this._ratio:1-this._ratio;this.options.zoomOffset=0}var o=this._map.getMinZoom()-this.options.zoomOffset;this._bounds=new r.LatLngBounds(this._map.unproject([e[0],e[3]],o),this._map.unproject([e[2],e[1]],o)).scale(this._ratio);this._size=i;this._origin=this._map.project(this._bounds.getCenter(),o);this._transformation=new r.Transformation(1,this._origin.x,1,this._origin.y);this._viewBoxOffset=r.point(this._bbox[0],this._bbox[1]);this._createContents(t);this._renderer._container.insertBefore(this._group,this._renderer._container.firstChild);this.fire("load");this._ready=true;this._latlngs=this._boundsToLatLngs(this._bounds);this._reset();if(this.options.useRaster){this.toImage()}},whenReady:function f(t,e){if(this._ready){t.call(e)}else{this.once("load",t,e)}return this},getDocument:function p(){return this._group},getRenderer:function _(){return this._renderer},_createContents:function g(t){r.SVG.copySVGContents(t,this._group)},getOriginalSize:function m(){var t=this._bbox;return new r.Point(Math.abs(t[0]-t[2]),Math.abs(t[1]-t[3]))},_updatePath:function v(){r.Rectangle.prototype._updatePath.call(this);if(this._group){var t=this._map.latLngToLayerPoint(this._bounds.getNorthWest());var e=this._map.options.crs.scale(this._map.getZoom()-this.options.zoomOffset)*this._ratio;this._group.setAttribute("transform",r.DomUtil.getMatrixString(t.subtract(this._viewBoxOffset.multiplyBy(e)),e));if(this._canvasRenderer){this._redrawCanvas(t,e)}}},_unscalePoint:function y(t){return this._transformation.transform(this._transformation.untransform(t).divideBy(this._ratio))},_scalePoint:function b(t){return this._transformation.transform(this._transformation.untransform(t).multiplyBy(this._ratio))},getRatio:function x(){return this._ratio},projectPoint:function w(t){var e=this._map;return this._unscalePoint(e.project(t,e.getMinZoom()+this.options.zoomOffset))},unprojectPoint:function S(t){var e=this._map;return e.unproject(this._scalePoint(t),e.getMinZoom()+this.options.zoomOffset)},unprojectBounds:function B(t){var e=this.unprojectPoint(t.min);var i=this.unprojectPoint(t.max);return r.latLngBounds(e,i)},projectBounds:function C(t){return new r.Bounds(this.projectPoint(t.getSouthWest()),this.projectPoint(t.getNorthEast()))},exportSVG:function R(t,e){var i=this._renderer.exportSVG(e);return t?i.outerHTML:i},toImage:function D(){var t=new Image;t.style.width=this._size.x+"px";t.style.height=this._size.y+"px";t.src=this.toBase64();r.DomEvent.on(t,"load",function(){r.point(t.offsetWidth,t.offsetHeight);this._reset()},this);t.style.opacity=0;t.style.zIndex=-9999;t.style.pointerEvents="none";if(this._raster){this._raster.parentNode.removeChild(this._raster);this._raster=null}r.DomUtil.addClass(t,"schematic-image");this._renderer._container.parentNode.insertBefore(t,this._renderer._container);this._raster=t;return this},toBase64:function G(){var t=this._base64encoded||n.btoa(unescape(encodeURIComponent(this._processedData)));this._base64encoded=t;return"data:image/svg+xml;base64,"+t},_redrawCanvas:function L(t,e){if(!this._raster){return}var i=this.getOriginalSize().multiplyBy(e);var n=this._canvasRenderer._ctx;r.Util.requestAnimFrame(function(){n.drawImage(this._raster,t.x,t.y,i.x,i.y)},this)},_showRaster:function A(){if(this._canvasRenderer&&!this._rasterShown){this._canvasRenderer._container.style.visibility="visible";this._group.style.display="none";this._rasterShown=true}},_hideRaster:function j(){if(this._canvasRenderer&&this._rasterShown){this._canvasRenderer._container.style.visibility="hidden";this._group.style.display="block";this._rasterShown=false}},_onPreDrag:function V(){if(this.options.useRaster){this._showRaster()}},_onDragEnd:function P(){if(this.options.useRaster){this._hideRaster()}}});r.Schematic.prototype.project=r.Schematic.prototype.projectPoint;r.Schematic.prototype.unproject=r.Schematic.prototype.unprojectPoint;r.schematic=function(t,e,i){return new r.Schematic(t,e,i)}},{"./bounds":3,"./renderer":4,"./utils":6,Base64:2,leaflet:undefined}],6:[function(t,e,i){"use strict";var r=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol==="function"&&t.constructor===Symbol?"symbol":typeof t};var n=t("leaflet");n.Browser.phantomjs=navigator.userAgent.toLowerCase().indexOf("phantom");if("SVGElementInstance"in window){Object.defineProperty(SVGElementInstance.prototype,"className",{get:function s(){return this.correspondingElement.className.baseVal},set:function a(t){this.correspondingElement.className.baseVal=t}})}n.DomUtil.isNode=function(t){return(typeof Node==="undefined"?"undefined":r(Node))==="object"?t instanceof Node:t&&(typeof t==="undefined"?"undefined":r(t))==="object"&&typeof t.nodeType==="number"&&typeof t.nodeName==="string"};n.DomUtil.getSVGBBox=function(t){var e;var i=parseInt(t.getAttribute("width"),10);var r=parseInt(t.getAttribute("height"),10);var n=t.getAttribute("viewBox");var s;if(n){s=n.split(" ").map(parseFloat);e=[s[0],s[1],s[0]+s[2],s[1]+s[3]]}else if(i&&r){e=[0,0,i,r]}else{var a=t.cloneNode(true);a.style.position="absolute";a.style.top=0;a.style.left=0;a.style.zIndex=-1;a.style.opacity=0;document.body.appendChild(a);if(a.clientWidth&&a.clientHeight){e=[0,0,a.clientWidth,a.clientHeight]}else{e=o(a)}document.body.removeChild(a)}return e};function o(t){var e=[Infinity,Infinity,-Infinity,-Infinity];var i=[].slice.call(t.querySelectorAll("*"));var r=Math.min,n=Math.max;for(var o=0,s=i.length;o<s;o++){var a=i[o];if(a.getBBox){a=a.getBBox();e[0]=r(a.x,e[0]);e[1]=r(a.y,e[1]);e[2]=n(a.x+a.width,e[2]);e[3]=n(a.y+a.height,e[3])}}return e}n.DomUtil.getSVGContainer=function(t){var e=document.createElement("div");e.innerHTML=t;return e.querySelector("svg")};n.DomUtil.getMatrixString=function(t,e){return"matrix("+[e,0,0,e,t.x,t.y].join(",")+")"};n.SVG.copySVGContents=function(t,e){if(n.Browser.ie||n.Browser.phantomjs){var i=t.firstChild;do{e.appendChild(i);i=t.firstChild}while(i)}else{e.innerHTML=t.innerHTML}}},{leaflet:undefined}]},{},[1])(1)});